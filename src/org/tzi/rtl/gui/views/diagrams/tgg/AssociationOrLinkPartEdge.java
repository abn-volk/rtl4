...
// $Id: AssociationOrLinkPartEdge.java 2505 2011-09-15 18:42:21Z lhamann $

package org.tzi.rtl.gui.views.diagrams.tgg;

import org.tzi.rtl.gui.views.diagrams.tgg.waypoints.WayPoint;
import org.tzi.rtl.gui.views.diagrams.tgg.waypoints.WayPointType;
    ...
    protected void drawAssociationKind( Graphics g, Point2D p2d1, Point2D p2d2, int kind ) {
        ...
        try {
            ...
            case MAggregationKind.NONE:
                DirectedEdgeFactory.drawAssociation( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            case MAggregationKind.AGGREGATION:
                DirectedEdgeFactory.drawAggregation( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            case MAggregationKind.AGGREGATION + DIRECTED_EDGE:
                DirectedEdgeFactory.drawDirectedAggregation( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            case MAggregationKind.COMPOSITION:
                DirectedEdgeFactory.drawComposition( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            case MAggregationKind.COMPOSITION + DIRECTED_EDGE:
                DirectedEdgeFactory.drawDirectedComposition( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            case DIRECTED_EDGE:
                DirectedEdgeFactory.drawDirectedEdge( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
            default:
                DirectedEdgeFactory.drawAssociation( g, p1.x, p1.y, p2.x, p2.y, false );
                break;
