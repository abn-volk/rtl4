...
import org.tzi.rtl.gui.views.diagrams.tgg.NodeBase;
...
public class ObjectNode extends NodeBase implements SortChangeListener {
    ...
    public ObjectNode( MObject obj, int groupId, TggDiagramView parent,
                       DiagramOptions opt ) {
        fObject = obj;
        fGroupId = groupId;
        fParent = parent;
    ...
    public MSystemState getSystemState_LHS(){
    	return fParent.getTggRule().getSystemState_LHS();
    }
    public MSystemState getSystemState_RHS(){    	
    	return fParent.getTggRule().getSystemState_RHS();
    }
    ...
    public void setRectangleSize( Graphics2D g ) {
        ...
        MObjectState objState = fObject.state( this.getSystemState_RHS() );
