...
public abstract class PlaceableNode implements Layoutable, Selectable {
     ...
     * When first drawn @link {@link #setRectangleSize(java.awt.Graphics2D)} and {@link #onFirstDraw(java.awt.Graphics2D)} are called
     * and afterwards {@link #onDraw(java.awt.Graphics2D)}.
     * After the first draw only {@link #onDraw(java.awt.Graphics2D)} is called.
	 ...
	 * @return {@link org.tzi.use.gui.views.diagrams.util.Direction#NORTH}, {@link org.tzi.use.gui.views.diagrams.util.Direction#EAST}, {@link org.tzi.use.gui.views.diagrams.util.Direction#SOUTH}, {@link org.tzi.use.gui.views.diagrams.util.Direction#WEST} or <code>null</code> if
