...
import org.tzi.rtl.gui.views.diagrams.tgg.waypoints.*;
...
public abstract class EdgeBase extends DirectedEdgeBase<NodeBase> implements Selectable {
     ...
     * When first drawn {@link #onFirstDraw(java.awt.Graphics2D)} is called
    ...
    /**
     * Before the new position of an edge is calculated by {@link #calculateNewPositions(java.util.Set)}
     ...
     * {@link #calculateNewPositions(java.util.Set)}.
