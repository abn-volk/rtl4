...
// $Id: BinaryAssociationClassOrObject.java 2495 2011-09-13 14:24:33Z lhamann $
...
/**
 * Extends the {@link org.tzi.rtl.gui.views.diagrams.tgg.BinaryAssociationOrLinkEdge} to additionally
...
public class BinaryAssociationClassOrObject extends BinaryAssociationOrLinkEdge {
    ...
    public BinaryAssociationClassOrObject( NodeBase source, NodeBase target,
                     ...
                     DiagramView diagram, MAssociation assoc, int groupId ) {
        super( source, target, sourceEnd, targetEnd, diagram, assoc, groupId );
    ...
    public BinaryAssociationClassOrObject( NodeBase source, NodeBase target,
                     MAssociationEnd sourceEnd, MAssociationEnd targetEnd,
                     NodeBase associationClassOrObjectNode,
                     DiagramView diagram, MLink link, int groupId ) {
        super( source, target, sourceEnd, targetEnd, diagram, link, groupId );
        initNodeEdge( associationClassOrObjectNode );
    }
